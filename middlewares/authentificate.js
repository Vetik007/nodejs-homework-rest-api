...
const authentificate = async (req, res, next) => {
  ...
  try {
    // перевіряємо справжність токена за допомогою секретного ключа. Якщо токен не валідний повертається помилка, якщо валідний повертається payload в которого ми забираємо id
